...
export default function Footer() {
  ...
  return (
    <footer className="bg-white py-12 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
      <Container>
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400 max-w-xs">
              A comprehensive digital inspection system for hazardous materials management.
            </p>
          </div>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-6 flex flex-col-reverse sm:flex-row justify-between items-center">
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-4 sm:mt-0">
            &copy; {currentYear} Greenhouse Management System. All rights reserved.
          </p>
